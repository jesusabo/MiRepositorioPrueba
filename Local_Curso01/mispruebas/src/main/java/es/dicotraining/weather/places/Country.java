...
public class Country {
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, Country.NOT_FOUND_VALUE);
        if (Country.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(code).append(type).append(woeid).append(content).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(code, rhs.code).append(type, rhs.type).append(woeid, rhs.woeid).append(content, rhs.content).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
